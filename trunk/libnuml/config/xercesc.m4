...
dnl Revision    : $Id: xercesc.m4 9814 2009-07-16 01:52:41Z mhucka $
dnl $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/branches/rel-4-0-0/config/xercesc.m4 $
dnl
dnl <!-------------------------------------------------------------------------
...
#define XERCES_CPP_NAMESPACE_QUALIFIER
  ...
  LIBNUML_OPTIONS="$LIBNUML_OPTIONS USE_XERCES"
