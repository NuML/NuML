...
dnl $Id: libcheck.m4 8784 2009-01-09 08:37:06Z mhucka $
dnl $HeadURL: https://numl.svn.sourceforge.net/svnroot/numl/branches/rel-4-0-0/config/libcheck.m4 $
dnl
dnl ---------------------------------------------------------------------------
...
dnl Default minimum version is 0.9.2 because that's the minimum LibNUML needs.
dnl
...
#include <check.h>
  ...
  LIBNUML_OPTIONS="$LIBNUML_OPTIONS USE_LIBCHECK"
