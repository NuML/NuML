...
dnl Revision    : $Id: octave.m4 8909 2009-01-19 07:16:58Z mhucka $
dnl $HeadURL: https://sbrml.svn.sourceforge.net/svnroot/sbrml/branches/rel-4-0-0/config/octave.m4 $
dnl
dnl <!-------------------------------------------------------------------------
...
[
  ...
  LIBSBRML_OPTIONS="$LIBSBRML_OPTIONS USE_OCTAVE"
