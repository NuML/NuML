...
dnl
dnl $Id: expat.m4 10587 2009-12-30 17:40:28Z ajouraku $
dnl $HeadURL: https://numl.svn.sourceforge.net/svnroot/numl/branches/rel-4-0-0/config/expat.m4 $
dnl 
dnl ---------------------------------------------------------------------------
...
dnl Default minimum version is 1.95.8 because that's the minimum LibNUML needs.
...
#include <expat.h>
  ...
  LIBNUML_OPTIONS="$LIBNUML_OPTIONS USE_EXPAT"
