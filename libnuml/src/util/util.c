 ...
 *
 * $Id: util.c 9686 2009-06-30 17:37:35Z ajouraku $
 * $HeadURL: https://numl.svn.sourceforge.net/svnroot/numl/branches/rel-4-0-0/src/util/util.c $
 *
 *<!---------------------------------------------------------------------------
 ...
 * useful inside and outside of libNUML.
 */
