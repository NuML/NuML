...
bool
SyntaxChecker::isValidNUMLSId(std::string sid)
{
                                     ...
                                     NUMLNamespaces * numlns)
{
  ...
  */
  XMLNamespaces *toplevelNS = (numlns) ? numlns->getNamespaces() : 0;
...
SyntaxChecker_isValidNUMLSId(const char * sid)
{
  return static_cast<int>((sid == NULL) ? 
    SyntaxChecker::isValidNUMLSId("") : SyntaxChecker::isValidNUMLSId(sid));
}
 ...
 * @param numlns the NUMLNamespaces_t structure associated with the object.
 *
 * @return @c true (non-zero) if the XMLNode_t structure conforms, 
 * @c false (0) otherwise.
 *
 * @note the optional NUMLNamespaces_t argument can be used to
                                     ...
                                     NUMLNamespaces_t * numlns)
{
  return static_cast<int>
                        (SyntaxChecker::hasExpectedXHTMLSyntax(node, numlns));
}
