...
ExpatHandler::ExpatHandler (XML_Parser parser, XMLHandler& handler) :
 ...
 , mHandler( handler )
{
  XML_SetXmlDeclHandler      ( mParser, LIBNUML_CPP_NAMESPACE ::XMLDeclHandler    );
  XML_SetElementHandler      ( mParser, LIBNUML_CPP_NAMESPACE ::startElement,
                                        LIBNUML_CPP_NAMESPACE ::endElement        );
  XML_SetCharacterDataHandler( mParser, LIBNUML_CPP_NAMESPACE ::characters        );
  XML_SetNamespaceDeclHandler( mParser, LIBNUML_CPP_NAMESPACE ::startNamespace, 0 );
